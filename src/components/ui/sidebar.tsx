...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="iconSm"
      className={cn("text-gray-300 hover:text-gray-50 hover:bg-gray-800", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground peer-hover/menu-button:text-sidebar-accent-foreground absolute !top-[4px] right-1 flex aspect-square w-6 items-center justify-center rounded-sm p-0 outline-hidden transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0 cursor-pointer",
        // Increases the hit area of the button on mobile.
        "after:absolute after:-inset-2 md:after:hidden",
